...
public class sohbetCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sohbet_category);
        ...
        final DatabaseReference dbRef = database.getReference("ChatSubjects");
        ...
        lv_chatOdalari.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent odaIntent=new Intent(getApplicationContext(),chat.class);
