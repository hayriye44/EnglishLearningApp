...
public class chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<Message> mesajList=new ArrayList<Message>();

        final FirebaseUser firebaseUser= FirebaseAuth.getInstance().getCurrentUser();

        database=FirebaseDatabase.getInstance();
        final DatabaseReference dbRef=database.getReference("ChatSubjects/"+oda);
        ...
        buttonGonder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbRef.push().setValue(new Message(gonderen,mesaj,zaman));
                et_mesaj.setText("");
            }
        });
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds:dataSnapshot.getChildren()){
                    mesajList.add(ds.getValue(Message.class));
                }
